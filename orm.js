...
//const sequelize = new Orm('sihteeri', 'testi', 'testitesti', {
const sequelize = new Orm('sihteeri', 'testi', 'testi', {

// Jenkins testitietokanta
//const sequelize = new Orm('database_r10', 'database_user10', 'user_password10', { port: 3306
    host: 'localhost',
    dialect: 'mysql',
...
Setting.Notification=Setting.hasOne(Notification);
...
Profile.belongsToMany(Account, {through: Contacts});
Account.belongsToMany(Profile, {through: Contacts});
